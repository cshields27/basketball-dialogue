...
QUESTIONS_PATH = '../../data/questions_assists.test'
ANSWERS_PATH = '../../data/answers_assists.test'
...
def generate_qa(types_to_qs):
  ...
  for line in lines:
    ...
    for question_temp in types_to_qs['player_assists']:
      ...
      if status == 'Inactive':
        ...
        answer = f'{name} averaged {apg} assists per game in his career.'
      else:
        answer = f'{name} averaged {apg} assists per game in the {season} season.'
