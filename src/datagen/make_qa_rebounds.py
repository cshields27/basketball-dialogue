...
QUESTIONS_PATH = '../../data/questions_rebounds.test'
ANSWERS_PATH = '../../data/answers_rebounds.test'
  ...
  for line in lines:
    ...
    for question_temp in types_to_qs['player_rebounds']:
      ...
      if status == 'Inactive':
        ...
        answer = f'{name} averaged {rpg} rebounds per game in his career.'
      else:
        answer = f'{name} averaged {rpg} rebounds per game in the {season} season.'
