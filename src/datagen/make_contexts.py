...
def generate_contexts():
  # Open file
  f = open('../../data/contexts_original_temp.test', 'w')
  ...
  for player in players.get_players():
    try:
      ...
      common_player_info = commonplayerinfo.CommonPlayerInfo(player_id=player['id'], timeout=50)
      ...
      player_stats = common_player_info.player_headline_stats.get_dict()
      ...
      career_data = dict()
      averages = dict(zip(player_stats['headers'], player_stats['data'][0]))
      ...
      player['averages'] = averages

      f.write('STARTTAG {} ENDTAG\n'.format(str(player)))
